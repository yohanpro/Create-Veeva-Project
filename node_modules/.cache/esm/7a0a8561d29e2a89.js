let fs,shell,DIRECTORIES;_d29‍.x([["makeGulpfileJs",()=>makeGulpfileJs]]);_d29‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_d29‍.w("shelljs",[["default",["shell"],function(v){shell=v}]]);_d29‍.w("../main",[["DIRECTORIES",["DIRECTORIES"],function(v){DIRECTORIES=v}]]);
...
`;
  _d29‍.a("shell",shell).cd(_d29‍.a("DIRECTORIES",DIRECTORIES).rootDir);
  _d29‍.a("fs",fs).writeFileSync('gulpfile.js', gulpfile, 'utf8', err => _d29‍.g.console.log(err))
};_d29‍.j(["makeGulpfileJs"]);
...
const getPresentation = (options) => {
  ...
  _d29‍.g.console.log(presentation)
  return presentation;
}