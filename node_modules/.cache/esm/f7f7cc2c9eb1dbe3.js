let shell,fs,DIRECTORIES,path,createCsvWriter;_9eb‍.x([["makeCSVFile",()=>makeCSVFile]]);_9eb‍.w("shelljs",[["default",["shell"],function(v){shell=v}]]);_9eb‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_9eb‍.w("../main",[["DIRECTORIES",["DIRECTORIES"],function(v){DIRECTORIES=v}]]);_9eb‍.w("path",[["default",["path"],function(v){path=v}]]);_9eb‍.w("csv-writer",[["createObjectCsvWriter",["createCsvWriter"],function(v){createCsvWriter=v}]]);
...
let optionsInstance = null;
       const makeCSVFile = (options) => {
    optionsInstance = options;
    const csvWriter = _9eb‍.a("createCsvWriter",createCsvWriter)({
